...
categories: [ctf]
tags: [forensics,htb]
description: Writeup for all forensics challenges from Hack the Boo 2023.
image: /assets/posts/htboo2023/icon.jpg
---

This was my very first CTF and my first writeup so the explanations might be super scuffed. With hindsight, the challenges were actually pretty simple but I guess everyone starts from the bottom.
