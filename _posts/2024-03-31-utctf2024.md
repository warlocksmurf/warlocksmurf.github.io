...
This is a writeup for some forensics challenges from UTCTF 2024. I was super happy that I almost managed to solve every forensics challenges solo during this CTF, showing how much of an improvement I've gain over the past few months. Overall, very proud of this writeup. PS: an OSINT category should be created instead of mixing in with forensics.
...
We are given a PDF file to investigate. The PDF file seems to be a contract with signature images below it. Analyzing it with binwalk, nothing interesting can be found other than the text.
...
We are given a YouTube video to investigate. Extracting the audio and analyzing it on Audacity, a suspicious spike can be found in this audio.
