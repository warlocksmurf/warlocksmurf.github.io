...
categories: [ctf]
tags: [misc,idek]
image: /assets/posts/idekctf2024/icon2.png
---

This is a writeup for an interesting misc challenge from idekCTF 2024. Overall, the CTF was very enjoyable with super difficult challenges. Shame that I've spent so many hours doing the OSINT challenges that I forgot about the rest, so I tried this challenge after the CTF.
