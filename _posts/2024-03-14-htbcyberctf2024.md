...
image: /assets/posts/htbcyberctf2024/icon.jpg
---

This is a writeup for forensics and hardware challenges from HTB Cyber Apocalypse CTF 2024 Hacker Royale. Despite not clearing the insane difficulty challenge, I was still happy that I managed to solve almost all of the forensics challenges. Huge shoutout to my teammate @ayam for being helpful in giving nudges for the hard difficulty challenges since he cleared them already, I wish we can meet in the next M53 gathering.
