...
This is a writeup for forensics and hardware challenges from Cyber Apocalypse 2024: Hacker Royale. During this CTF, I handled forensics challenges for M53 but another teammate @ayam basically solved every forensics challenges for us. Despite being solved, I went ahead and attempted the challenges myself and managed to obtain the flags. I want to give a huge shoutout to @ayam for being helpful in giving hints for the hard difficulty challenges and also teaching me simple C# coding, I wish we can meet in the next M53 gathering.
