---
title: HTB Cyber Apocalypse CTF 2024 Hacker Royale - Writeups
date: 2024-03-14 12:00:00
categories: [ctf]
tags: [forensics,hardware,htb]
---

This is a writeup for forensics and hardware challenges from HTB Cyber Apocalypse CTF 2024 Hacker Royale. Despite most of the forensics challenges being solved by my teammate @ayam, I went and attempted the challenges myself to learn. Huge shoutout to @ayam for being helpful in giving hints for the hard difficulty challenges, I wish we can meet in the next M53 gathering.

> Credits to @desutruction for this hilarious meme

![doge](/assets/posts/htbcyberctf2024/doge.png)

## Scenario
> "We used to be peaceful and had enough tech to keep us all happy. What do you think about that? <br><br>
These data disks alluded to some "societal golden age." No fighting, no backstabbing, and no factions fighting for some lousy title. <br><br>
Good, great for them-<br><br>
Because all we get to look forward to is "The Fray." <br><br>
alarms blaring<br><br>
Oh, look-... it's showtime." <br><br>
(Quote: Luxx, faction leader of the Phreaks) <br><br>
💥 Welcome to "The Fray." A societal gauntlet made of the most cunning, dedicated, and bloodthirsty factions. We are all bound by the same rule–be one of the last factions standing. All brought to your overlords and sponsors at KORP™. <br><br>
Our city's lights bring people from far and wide. It's one of the last remaining mega structures left after the Great Division took place. But, as far as we are concerned, KORP™ is all there ever was and will be. <br><br>
...
![sight1](/assets/posts/htbcyberctf2024/sight1.png)

2. What time is the first successful Login

![sight2](/assets/posts/htbcyberctf2024/sight2.png)

3. What is the time of the unusual Login

![sight3](/assets/posts/htbcyberctf2024/sight3.png)

4. What is the Fingerprint of the attacker's public key'

![sight4](/assets/posts/htbcyberctf2024/sight4.png)

5. What is the first command the attacker executed after logging in

![sight5](/assets/posts/htbcyberctf2024/sight5.png)

6. What is the final command the attacker executed before logging out

![sight6](/assets/posts/htbcyberctf2024/sight6.png)
...
![urgent](/assets/posts/htbcyberctf2024/urgent.png)
...
![boost1](/assets/posts/htbcyberctf2024/boost1.png)
...
![boost2](/assets/posts/htbcyberctf2024/boost2.png)
...
![boost3](/assets/posts/htbcyberctf2024/boost3.png)

![boost4](/assets/posts/htbcyberctf2024/boost4.png)

![boost5](/assets/posts/htbcyberctf2024/boost5.png)
...
![siege1](/assets/posts/htbcyberctf2024/siege1.png)
...
![siege2](/assets/posts/htbcyberctf2024/siege2.png)

So I had to use `dnSpy` to decompile the malicious exe file and found an encryption and decryption method within the `Program` class. Additionally, the encryption key can also be found in the `Constantes` class.

![siege3](/assets/posts/htbcyberctf2024/siege3.png)

![siege3_5](/assets/posts/htbcyberctf2024/siege3_5.png)

![siege4](/assets/posts/htbcyberctf2024/siege4.png)
...
![siege5](/assets/posts/htbcyberctf2024/siege5.png)
...
For the third part, it was just encoded with base64 so the script was not required.

![siege6](/assets/posts/htbcyberctf2024/siege6.png)
...
![phreak1](/assets/posts/htbcyberctf2024/phreak1.png)

![phreak2](/assets/posts/htbcyberctf2024/phreak2.png)
...
```
![phreak3](/assets/posts/htbcyberctf2024/phreak3.png)
...
Function within second Javascript file:
```js
...
function eRNv(caA2) {
...
The flag: `S47T.SETREQUESTHEADER("Cookie:", "flag=SFRCe200bGQwY3NfNHIzX2czdHQxbmdfVHIxY2tpMTNyfQo=");`
```
...
![confinement1](/assets/posts/htbcyberctf2024/confinement1.png)
...
![confinement2](/assets/posts/htbcyberctf2024/confinement2.png)
...
![confinement3](/assets/posts/htbcyberctf2024/confinement3.png)
...
![confinement4](/assets/posts/htbcyberctf2024/confinement4.png)
...
![confinement5](/assets/posts/htbcyberctf2024/confinement5.png)
...
However, only the salt value was specified but not the UID. Additionally, the UID generation seems to be randomly generated with the `GenerateUserID` method, so at this point I was pretty confused on what I should do next.
...
Looking back at the `Main` method, it seems that the `Alert` method might have the UID somewhere with the two email addresses.
...
![confinement11](/assets/posts/htbcyberctf2024/confinement11.png)

With the UID and salt, I slightly modified the `CoreEncrypter` class to create my own method to decrypt the file.
...
![confinement12](/assets/posts/htbcyberctf2024/confinement12.png)

![confinement13](/assets/posts/htbcyberctf2024/confinement13.png)

### Oblique Final [Forensics]
...
![maze1](/assets/posts/htbcyberctf2024/maze1.png)
...
![rabbit1](/assets/posts/htbcyberctf2024/rabbit1.png)

![rabbit2](/assets/posts/htbcyberctf2024/rabbit2.png)
...
![rabbit3](/assets/posts/htbcyberctf2024/rabbit3.png)

![rabbit4](/assets/posts/htbcyberctf2024/rabbit4.png)

Since the queue has 6 messages, we can use the function to output the messages and the flag can be obtained.

![rabbit5](/assets/posts/htbcyberctf2024/rabbit5.png)
