...
Filter the notepad process for powershell commands again, an obfuscated powershell command can be identified,
...
Deobfuscating it, the password can be obtained as `5up3r-5ecur3`.
