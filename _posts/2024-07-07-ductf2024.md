...
description: Writeup for all forensics challenges from DownUnderCTF 2024
image: /assets/posts/ductf2024/icon2.png
---

Overall, an extremely enjoyable CTF with great challenges and a mesmerizing theme using cute imagery. This was also my first time playing at a local bar with my friends to solve challenges together and have fun. 
...
Fun note: one of the authors gave the whole attack chain relating to every forensics challenge.
