...
This is a writeup for all forensics challenges from bi0sCTF 2024. Unfortunately, I was busy with my internship so I could not finish the forensic challenges before the CTF ended. However, I did attempt them after the CTF to improve my DFIR skills and I managed to find all the flags!! (If only I had time to play it)
