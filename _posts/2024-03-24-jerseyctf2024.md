...
Another interesting method from @0x157 was that most processes can be actually loaded into GIMP as `.data` to read its content. [Blog 1](https://w00tsec.blogspot.com/2015/02/extracting-raw-pictures-from-memory.html) and [Blog 2](https://www.rootusers.com/google-ctf-2016-forensic-for1-write-up/) talks about his method and it is very interesting.
...
Cracking the zip file, we are given another text file with weird text. Researching online, I stumbled upon this [blog](https://aashutoshlodhi.medium.com/base-ffff-1-decoding-beyond-base64-f9f65d6400c2) that mentioned the decoding technique was [Base65536](https://www.better-converter.com/Encoders-Decoders/Base65536-Decode) (no joke). Decoding it gives us the flag.
