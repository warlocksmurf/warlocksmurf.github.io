...
This is a writeup for forensics, networking, steganography and web challenges from KnightCTF 2024. Overall, the CTF was very fun where I could train my DFIR skills in a realistic environment. However, I really hated the 10 attempts flag submission feature which blocked me in solving some networking challenges. Hope CTFs never use this feature ever again.
