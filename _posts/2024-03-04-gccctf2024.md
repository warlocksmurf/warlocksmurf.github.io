...
This is a writeup for forensics, OSINT, steganography, misc and web challenges from GCC CTF 2024. During this CTF, I collaborated with @Odin to solve every forensics challenges. However, I was busy with another CTF during that time so I have to give credits to him for doing most of the work solving the challenges.
