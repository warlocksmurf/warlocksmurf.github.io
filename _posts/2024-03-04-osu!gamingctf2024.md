...
This is a writeup for forensics, OSINT, web, misc and osu challenges from osu!gamingCTF 2024. Overall, this was the most creative and unique CTF I've ever joined. Pretty impressive for osu! to create a CTF compeition out of nowhere with challenges related to their rhythm game osu!. They even have their own category called `osu` LMAO.
